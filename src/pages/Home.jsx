    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 flex flex-col items-center justify-center p-6">
      <div className="max-w-4xl w-full text-center">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
            <h2 className="text-3xl font-semibold text-indigo-700 mb-4">Blog</h2>
            <p className="text-gray-600 mb-6">
              Articles, tips, and insights on building wealth with faith and family.
            </p>
            <div className="flex flex-col sm:flex-row gap-3">
              <Link
                to="/blog/catholic-families-building-generational-wealth-with-ai-prayer-and-fi-stewardship"
                className="inline-block px-8 py-4 bg-indigo-600 text-white font-semibold rounded-xl hover:bg-indigo-700 transition-colors text-lg flex-1 text-center"
              >
                Read Latest Post →
              </Link>
              <Link
                to="/blog"
                className="inline-block px-8 py-4 border-2 border-indigo-600 text-indigo-600 font-semibold rounded-xl hover:bg-indigo-50 transition-colors text-lg flex-1 text-center"
              >
                Browse All Posts →
              </Link>
            </div>
