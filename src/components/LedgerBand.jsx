...
/**
 * Compact “this week’s Ledger” card — home, blog index.
 * One primary CTA (read this week). Email signup lives on SubscribeForm.
 */
export default function LedgerBand({ compact = false }) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-emerald-100 p-5 sm:p-6 shadow-sm">
      ...
      <ul className={`space-y-2 ${compact ? 'mb-4 mt-3' : 'mb-5'}`}>
