    ...
    return (
      <div className="w-full" ref={wizardRef}>
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-xs sm:text-sm text-gray-600 text-center mb-4 max-w-2xl mx-auto leading-relaxed">
            What these numbers mean: portfolio only (home equity stays out). Your remaining mortgage balance is added to the FI target each year. Time to FI is the first year the projected portfolio stays at or above that inflation-adjusted target for every year after.
          </p>
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-5 sm:p-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div><label className="block text-sm font-semibold mb-2">Monthly payment</label>
                      <div className="relative"><span className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500">$</span>
                      <MoneyField ariaLabel="Monthly payment" value={monthlyPayment} onChange={setMonthlyPayment} className={mc} /></div></div>
                  </div>
                </div>
              )}
            </div>
          ...
          {step === 3 && (
            <div className="space-y-5">
              ...
              <label className="flex items-center gap-2"><input type="checkbox" checked={buyingVehicle} onChange={(e) => setBuyingVehicle(e.target.checked)} className="rounded" /><span className="text-sm font-medium">Buying vehicle(s)</span></label>
              {buyingVehicle && (
                <div className="space-y-3">
                  {vehicles.map((v, idx) => (
