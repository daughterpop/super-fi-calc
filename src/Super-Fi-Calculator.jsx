      ...
      <div className="w-full" ref={wizardRef}>
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-xs sm:text-sm text-gray-600 text-center mb-4 max-w-2xl mx-auto leading-relaxed">
            Portfolio only — home equity stays out. Remaining mortgage is added to the FI target each year. Time to FI is the first year the projected portfolio stays at or above that inflation-adjusted target thereafter.
          </p>
