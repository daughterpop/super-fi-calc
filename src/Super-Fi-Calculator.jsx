      ...
      <div className="w-full" ref={wizardRef}>
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
              <div className="text-sm text-gray-500 mb-2">Current Savings</div>
              <div className="text-2xl font-bold">{formatCompact(currentSavings)}</div>
              <div className="text-xs text-gray-500">Target: {formatCompact(results.currentTotalFI)}</div>
            </div>
            <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
          ...
          {step === 0 && (
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div><label htmlFor="fi-current-savings" className="block text-sm font-semibold mb-2">Current Savings</label>
                  <div className="relative"><span className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500">$</span>
                    <MoneyField id="fi-current-savings" ariaLabel="Current savings" value={currentSavings} onChange={setCurrentSavings} className={mc} /></div>
                  <p className="text-xs text-gray-500 mt-1">{formatCompact(currentSavings)} invested today</p></div>
              </div>
