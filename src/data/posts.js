const rawPosts = [
  {
    ...
    date: 'August 14, 2026',
    dateSort: '2026-08-14',
    excerpt: 'Financial margin is the practical foundation of Catholic FI: breathing room for prayer, kids, tithing, and vocation. How to build it without secular FIRE extremes — and how the saints model it.',
    readTime: '8 min read',
    link: '/blog/build-margin-for-catholic-families',
    tags: ['Stewardship', 'Legacy', 'Tithing', 'Prayer'],
    featured: true
  },
  {
