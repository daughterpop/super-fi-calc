export const tools_banking = [
  ...
  {
    id: 'venmo-debit-card',
    name: 'Venmo Debit Card',
    category: 'Banking & Payments',
    badge: '$10 after $50 spend',
    headline: 'Get the Venmo Debit Card and earn $10 after $50 in 30 days',
    description:
      'Get $10 when you get the Venmo Debit Card and spend $50 within 30 days. Terms apply. Use this link to start.',
    perks: [
      '$10 after you get the Venmo Debit Card and spend $50 in 30 days',
      'Spend from your Venmo balance at stores and online',
      'Same app you already use for splits and sends',
      'Handy for household allowances and everyday purchases',
    ],
    cta: 'Get the Venmo Debit Card — $10',
    href: 'https://get.venmo.com/QfSLyQv8C6b',
    accent: 'sky',
    icon: 'banknote',
    footnote: 'Offer requires getting the Venmo Debit Card and spending $50 within 30 days. Terms set by Venmo / PayPal and subject to change.',
    valueScore: 10,
  },
  {
    id: 'venmo',
    ...
    secondaryCta: 'Venmo Debit Card — $10',
    secondaryHref: 'https://get.venmo.com/QfSLyQv8C6b',
    accent: 'sky',
    icon: 'send',
    footnote: 'Signup reward requires this referral link and a qualifying personal payment of $5+ using a linked funding source. Debit card offer: $10 after $50 spend in 30 days. Terms: https://payp.al/ref — offers subject to change.',
    valueScore: 5,
  },
  {
    id: 'cashapp',
